 ...
 *            tipo da entidade
 */
public class JpaSerializer<T> extends Serializer<T>implements JsonSerializer<T>, JsonDeserializer<T> {
	 ...
	 */
	public JpaSerializer(final @NotNull EntityManager entityManager) {
